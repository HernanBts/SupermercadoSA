...
namespace SupermercadoSA.Controllers
{
    public class VerificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VerificationID,Name,Type")] Verification verification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VerificationID,Name,Type")] Verification verification)
        {
            if (ModelState.IsValid)
            {
